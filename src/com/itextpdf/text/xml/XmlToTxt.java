...
public class XmlToTxt implements SimpleXMLDocHandler {
	...
	/**
	 * @see SimpleXMLDocHandler#startElement(String, Map)
	 */
	public void startElement(String tag, Map<String, String> h) {
	}

	/**
	 * @see SimpleXMLDocHandler#endElement(String)
	 */
	public void endElement(String tag) {
	}

	/**
	 * @see SimpleXMLDocHandler#startDocument()
	 */
	public void startDocument() {
	}

	/**
	 * @see SimpleXMLDocHandler#endDocument()
	 */
	public void endDocument() {
	}

	/**
	 * @see SimpleXMLDocHandler#text(String)
	 */
