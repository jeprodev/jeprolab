/*
 * $Id: 5bba78408b2b311e532ea5e665e975373d4e84ef $
 *
...
public class ICC_Profile {
    ...
    public static ICC_Profile getInstance(byte[] data, int numComponents) {
        if (data.length < 128 || data[36] != 0x61 || data[37] != 0x63
                ...
                throw new IllegalArgumentException(MessageLocalization.getErrorBundle().getString("ITEXTPDF_MESSAGE")); // todo ComposedMessage("invalid.icc.profile"));
        try {
