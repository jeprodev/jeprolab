...
public final class PdfPatternPainter extends PdfTemplate {
    ...
    /**
     * @see PdfContentByte#setColorStroke(BaseColor)
     */
    ...
    /**
     * @see PdfContentByte#setColorFill(BaseColor)
     */
    ...
    /**
     * @see PdfContentByte#setPatternFill(PdfPatternPainter, BaseColor, float)
     */
    ...
    /**
     * @see PdfContentByte#setPatternStroke(PdfPatternPainter, BaseColor, float)
     */
    ...
    void checkNoColor() {
        if (stencil)
            throw new RuntimeException(MessageLocalization.getErrorBundle().getString("ITEXTPDF_MESSAGE")); // todo ComposedMessage("colors.are.not.allowed.in.uncolored.tile.patterns"));
    }
}
