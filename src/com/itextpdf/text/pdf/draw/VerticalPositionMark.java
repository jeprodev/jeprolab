/*
 * $Id: 78556e565c5fc8b3ba2a3e8c156bf95f79f32995 $
 *
...
public class VerticalPositionMark implements DrawInterface, Element {
	...
	/**
	 * @see DrawInterface#draw(com.itextpdf.text.pdf.PdfContentByte, float, float, float, float, float)
	 */
    ...
    /**
     * @see Element#process(ElementListener)
     */
