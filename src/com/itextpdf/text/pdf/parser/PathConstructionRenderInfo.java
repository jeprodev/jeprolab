/*
 * $Id: a5201e44c67a9f4cbf90d9e18c2ea08c8c85d922 $
 *
...
public class PathConstructionRenderInfo {
    ...
    /**
     * See {@link Path#curveTo(float, float, float, float, float, float)}
     */
    public static final int CURVE_123 = 3;

    /**
     * See {@link Path#curveTo(float, float, float, float)}
     */
    public static final int CURVE_23 = 4;

    /**
     * See {@link Path#curveFromTo(float, float, float, float)}
     */
    public static final int CURVE_13 = 5;

    /**
     * See {@link Path#closeSubpath()}
     */
    public static final int CLOSE = 6;

    /**
     * See {@link Path#rectangle(float, float, float, float)}
     */
    ...
    /**
     * See {@link #PathConstructionRenderInfo(int, List, Matrix)}
     */
    ...
    /**
     * @return {@link List} containing data of a new segment (E.g. x, y, w, h for rectangle;
