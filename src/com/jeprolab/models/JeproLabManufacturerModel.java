...
/**
 * Created by jeproQxT on 02/02/2014.
 */
public class JeproLabManufacturerModel {
...
*/
    protected static Map<Integer, String> cacheName = new HashMap<>();
    /*
     ...
     * @return string name
     */
    public static String getNameById(int manufacturerId){
