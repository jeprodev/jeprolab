...
//todo edit edit adding
    ...
    public function getCartRules($filter = CartRule::FILTER_ACTION_ALL)
    {
        ...
        $virtual_context = JeproLabContext.getContext()->cloneContext();
    ...
    public function getProducts($refresh = false, $id_product = false, $id_country = null)
    {
        ...
        $cart_shop_context = JeproLabContext.getContext()->cloneContext();
    ...
    public function addCartRule($id_cart_rule)
    {
        ...
        $cartRule = new CartRule($id_cart_rule, JeproLabContext.getContext()->language->id);
    ...
    {
        if (!$shop) {
            $shop = JeproLabContext.getContext()->shop;
        }

        if (JeproLabContext.getContext()->customer->id) {
        if ($id_address_delivery == 0 && (int)this.id_address_delivery) { // The $id_address_delivery is null, use the cart delivery address
            ...
            $id_address_delivery = (int)Address::getFirstCustomerAddressId((int)JeproLabContext.getContext()->customer->id);
        } elseif (!Customer::customerHasAddress(JeproLabContext.getContext()->customer->id, $id_address_delivery)) { // The $id_address_delivery must be linked with customer
    ...
    * /
    ...
    public function getDeliveryOptionList(Country $default_country = null, $flush = false)
    {
        ...
        $cart_rules = CartRule::getCustomerCartRules(JeproLabContext.getContext()->cookie->id_lang, JeproLabContext.getContext()->cookie->id_customer, true, true, false, $this, true);
    ...
    public function simulateCarriersOutput(Country $default_country = null, $flush = false)
    {
        ...
        if ($option['unique_carrier']) {
            ...
            if (isset($carrier['instance'])) {
                ...
                $delay = isset($delay[JeproLabContext.getContext()->language->id]) ?
                $delay[JeproLabContext.getContext()->language->id] : $delay[(int)Configuration::get('PS_LANG_DEFAULT')];
            }
    ...
    {
        if (isset(JeproLabContext.getContext()->cookie->id_country)) {
        $default_country = new Country(JeproLabContext.getContext()->cookie->id_country);
    }
    ...
    public function getPackageShippingCost($id_carrier = null, $use_tax = true, Country $default_country = null, $product_list = null, $id_zone = null)
    {
        ...
        if (!$default_country) {
            $default_country = JeproLabContext.getContext()->country;
        }
    ...
    public function checkQuantities($return_product = false)
    {
        ...
        if (!this.allow_seperated_package && !$product['allow_oosp'] && StockAvailable::dependsOnStock($product['id_product']) &&
                $product['advanced_stock_management'] && (bool)JeproLabContext.getContext()->customer->isLogged() && ($delivery = this.getDeliveryOption()) && !empty($delivery)) {
    ...
    public function getWsCartRows()
    {
        return Db::getInstance()->executeS('
            ...
            FROM `'._DB_PREFIX_.'cart_product`
        WHERE id_cart = '.(int)this.id.' AND id_shop = '.(int)JeproLabContext.getContext()->shop->id
        );
    }
    ...
    public function setWsCartRows($values)
    {
        if (this.deleteAssociations()) {
            ...
            foreach ($values as $value) {
                ...
                (int)$value['quantity'].', NOW(), '.(int)JeproLabContext.getContext()->shop->id.'),';
            }
    ...
    public function setProductAddressDelivery($id_product, $id_product_attribute, $old_id_address_delivery, $new_id_address_delivery)
    {
        ...
        if (!Customer::customerHasAddress(JeproLabContext.getContext()->customer->id, $new_id_address_delivery)) {
        return false;
    }
    ...
    public function autosetProductAddress()
    {
        ...
        if ((int)this.id_address_delivery > 0) {
            ...
            $id_address_delivery = (int)Address::getFirstCustomerAddressId(JeproLabContext.getContext()->customer->id);
        }
    ...
    public static function addExtraCarriers(&$array)
    {
        ...
        foreach (JeproLabContext.getContext()->cart->getAddressCollection() as $address) {
