...
/**
 * Created by jeproQxT on 02/02/2016.
 */
public class JeproLabSupplierModel {
    /** @var int supplier ID */
    ...
    protected static Map<Integer, String> cache_name = new HashMap<>();
     ...
     * @return string name
     */
    public static String getNameById(int supplierId){
